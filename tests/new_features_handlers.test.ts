...
describe("multi-page tool handlers", () => {
  describe("create-page", () => {
    it("should create a new page", async () => {
      ...
      assertEquals(parsed.data.page.name, "Details");
      assertEquals(parsed.data.page.id, "page-2");
    });
  });
  ...
  describe("list-pages", () => {
    it("should list all pages including active", async () => {
      ...
      const parsed = parseResult(result);
      assertEquals(parsed.data.pages.length, 2);
      assertEquals(parsed.data.active_page.id, "page-1");
    });
  });
  ...
  describe("get-active-page", () => {
    it("should return the active page", async () => {
      ...
      const parsed = parseResult(result);
      assertEquals(parsed.data.page.name, "Page-1");
    });
  });
  ...
  describe("set-active-page", () => {
    it("should switch pages", async () => {
      ...
      const parsed = parseResult(result);
      assertEquals(parsed.success, true);
      assertEquals(parsed.data.page.name, "P2");
    });
    ...
    it("should return error for non-existent page", async () => {
      ...
      const parsed = parseResult(result);
      assertEquals(parsed.error.code, "PAGE_NOT_FOUND");
    });
    ...
    it("should isolate cells between pages", async () => {
      ...
      assertEquals(stats2.total_cells, 1);
    });
  });
  ...
  describe("rename-page", () => {
    it("should rename a page", async () => {
      ...
      const parsed = parseResult(result);
      assertEquals(parsed.success, true);
      assertEquals(parsed.data.page.name, "Overview");
    });
  ...
  describe("delete-page", () => {
    it("should delete a page", async () => {
      ...
      assertEquals(parsed.data.remaining_pages.length, 1);
    });
    ...
    it("should error when deleting the last page", async () => {
      ...
      assertEquals(result.isError, true);
      const parsed = parseResult(result);
      assertEquals(parsed.error.code, "CANNOT_DELETE_LAST_PAGE");
    });
